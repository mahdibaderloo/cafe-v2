    ...
    <form className="bg-[#485158] rounded-2xl p-6 2xl:p-8 flex flex-col items-center w-150 2xl:w-240 z-50">
      ...
      <div className="w-full flex flex-col md:flex-row items-start mt-4 2xl:mt-10">
        <div className="flex-1 flex flex-col gap-3 2xl:gap-4 text-[1rem] xl:text-lg 2xl:text-xl text-white w-full">
          <label htmlFor="productName">مقدار تخفیف</label>
          <input
            type="text"
            id="productName"
        ...
        <div className="flex-1 flex flex-col gap-3 2xl:gap-4 text-[1rem] xl:text-lg 2xl:text-xl text-white w-full">
          <label htmlFor="price">حداکثر استفاده</label>
          <input
            type="text"
            id="price"
            value={data?.maxUsage}
      ...
      <div className="w-full flex flex-col md:flex-row items-start mt-4 2xl:mt-10">
        <div className="flex-1 flex flex-col gap-3 2xl:gap-4 text-[1rem] xl:text-lg 2xl:text-xl text-white w-full">
          <label htmlFor="productName">تاریخ ایجاد</label>
          <input
            type="text"
            id="productName"
        ...
        <div className="flex-1 flex flex-col gap-3 2xl:gap-4 text-[1rem] xl:text-lg 2xl:text-xl text-white w-full">
          <label htmlFor="price">تعداد استفاده شده</label>
          <input
            type="text"
            id="price"
      ...
      <div className="w-full flex items-start mt-4 2xl:mt-10">
        <div className="flex-1 flex flex-col gap-3 2xl:gap-4 text-[1rem] xl:text-lg 2xl:text-xl text-white w-full">
          <label htmlFor="price">تاریخ انقضا</label>
          <input
            type="text"
            id="price"
